            ...
            <div x-show="open" style="display: none;" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" x-transition.opacity>
                <div @click.outside="open = false" class="bg-white rounded-lg shadow-xl w-full max-w-lg transform transition-all" x-transition.scale>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Source / Category</label>
                        ...
                        <div>
                            ...
                            <textarea class="w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" rows="3" placeholder="Add notes..."></textarea>
                        </div>
                    </div>
                    <div class="px-6 py-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3 rounded-b-lg">
                        ...
                        <button @click="open = false" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-medium">Save Record</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200">
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <!-- Row 1 -->
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900">02 Feb 2026</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">Sumbangan Bulanan</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500">Donasi rutin dari Hamba Allah</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">+Rp 500.000</td>
                   ...
                   <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">Iuran Anggota</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500">Iuran bulan Februari - Ahmad Fauzi</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">+Rp 150.000</td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button class="text-slate-400 hover:text-blue-600 mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                            </button>
